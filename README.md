...
|---|---|---|
| Generar el dataset de entregas | Borja | ✅ Hecho |
| <sub>Con Python generamos un fichero con ~200.000 entregas ficticias que incluyen: ciudad, zona, día de la semana, tipo de producto, si llovía, si fue primer intento o reintento, y si la entrega falló. La tasa de fallos ronda el 23%. Script: `data/generate_synthetic.py`</sub> | | |
